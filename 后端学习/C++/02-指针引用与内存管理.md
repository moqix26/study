...
**为什么重要**：链表、树、引擎 Entity、网络缓冲区都靠门牌号串联；不懂指针读不懂 [数据结构 03 链表](../数据结构/02-线性结构/02-链表.md) 的 C++ 实现。
...
| C++ 02 | 对照 |
|--------|------|
| 堆上节点 + `next` 指针 | [数据结构 03 链表](../数据结构/02-线性结构/02-链表.md) |
| 连续内存数组 | [数据结构 02 数组](../数据结构/02-线性结构/01-数组.md) |
...
10. 节点含 `T data` + **`Node* next` 门牌号** → 见 [数据结构 03](../数据结构/02-线性结构/02-链表.md)。
...
## 21. 与 [数据结构 03 链表](../数据结构/02-线性结构/02-链表.md) 对照练
