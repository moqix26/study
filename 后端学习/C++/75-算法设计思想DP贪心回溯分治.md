...
> **交叉阅读**：[13 算法 C++ 实现](13-算法与数据结构C++实现.md)、[动态规划基础](../数据结构/08-高级算法专题/04-动态规划基础.md)、[14 面试专题](14-高频面试专题与场景题.md)。
...
| [动态规划基础](../数据结构/08-高级算法专题/04-动态规划基础.md) | 状态、转移与正确性直觉 |
...
7. **与数据结构高级专题？** 数据结构目录讲状态和推演，75 章补 C++ 模板与主定理。
