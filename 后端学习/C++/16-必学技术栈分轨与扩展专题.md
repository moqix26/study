...
| Linux 终端与 SSH | P1 | [Linux 01～03、10](../Linux/01-Linux入门与环境搭建.md) | 外部 |

### 2.4 算法与面试（P0～P1，仓库 13～15 + 数据结构）

| 内容 | 级别 | 掌握标准 | 章节 |
|------|------|----------|------|
| 复杂度、数组/链表/哈希/树 | P0 | 口述 + 手写核心 | [数据结构 01～06](../数据结构/00-学习路线图与说明.md) |
| C++ STL 手撕模板 | P0 | LRU、堆、并查集 | 13 |
| 精刷 50～80 题 | P1 | C++ 提交 | 13 + [数据结构 11](../数据结构/11-LeetCode刷题路线与题型汇总.md) |
...
| 系列 | C++ 主线下的用法 |
|------|------------------|
| [数据结构](../数据结构/00-学习路线图与说明.md) | **并行** 01～10；11 题单 + C++ 13 |
| [Linux](../Linux/00-学习路线图与说明.md) | 01～03、08、10～12；**14 章 Java 部署可跳过** |
