...
> **原理与手写实现**请先学 [数据结构核心模块](../数据结构/README.md)；本章侧重 **C++ STL 手撕**。
...
用 **C++ STL**（`vector`、`unordered_map`、`priority_queue` 等）按模板刷 **70 道题**，与 [数据结构系列](../数据结构/README.md) 原理互补——这里侧重「能写进面试白板」的代码。
...
| 原理不懂 | 先读 [数据结构核心模块](../数据结构/README.md) |
...
### 1.5 与 [数据结构系列](../数据结构/README.md) 分工表
...
> 本节在 §1～§23 基础上**系统补全**容器原理手写、算法模板与 50 道热题 C++ 代码。树结构原理见 [树形结构模块](../数据结构/04-树形结构/README.md)，前缀结构见 [Trie 字典树](../数据结构/04-树形结构/07-Trie字典树.md)，C++ 扩展实现见 [76 高级数据结构 C++ 实现](76-高级数据结构C++实现.md)。
...
**与 [红黑树精讲](../数据结构/04-树形结构/04-红黑树.md)**：红黑树性质、插入修复与删除双黑分析。
...
**与 [Trie 字典树](../数据结构/04-树形结构/07-Trie字典树.md)**：前缀树的插入、查询与删除；KMP、AC 自动机仍由本章扩展讲解。
...
### 24.10 与树形结构、Trie 和 76 章互补

| 主题 | [树形结构](../数据结构/04-树形结构/README.md) | [Trie 字典树](../数据结构/04-树形结构/07-Trie字典树.md) | [76 C++ 高级](76-高级数据结构C++实现.md) | 本章 13 |
|------|-----------------------------------------------|-------------------------------------------|------------------------------------------|---------|
